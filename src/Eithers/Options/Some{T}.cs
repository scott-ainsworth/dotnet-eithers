...
/// <summary>
///   A realization of <see cref="IOption{T}"/> that represents a Option that has a value.
/// </summary>
/// <typeparam name="T">The type of the value contained by the  <see cref="IOption{T}"/>
///   superclass.</typeparam>
[DebuggerDisplay("Some({Value})")]
public sealed class Some<T> : IOption<T> where T : notnull {
	...
	/// <summary>
	///   Gets the value wrapped by this <see cref="IOption{T}"/> instance.
	/// </summary>
	/// <value>
	///   The value wrapped by this <see cref="IOption{T}"/> instance.
	/// </value>
	...
	// /// <inheritdoc/>
	/// <summary>
	///   Determines whether the specified object equals the current <see cref="IOption{T}"/>
	///   instance.
	/// </summary>
	...
	/// <summary>
	///   Returns the hash code for this <see cref="IOption{T}"/>.
	/// </summary>
	/// <returns>
